...
export function Checkbox({ ...props }: Readonly<CheckboxProps>) {
  return (
    <RadixCheckbox.Root
      className={twMerge(
        'flex size-4 shrink-0 items-center justify-center rounded border border-zinc-600 bg-zinc-800 transition-colors duration-150 hover:border-zinc-500  ',
        'focus:focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2',
        'data-[state=checked]:border-indigo-400 data-[state=checked]:bg-indigo-400 cursor-pointer',
      )}
      {...props}
    >
